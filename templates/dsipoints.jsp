...
<br><br>
        <div id="button_256x56" class="button_256x56" shpbtn>
            <a href="#?=1">
            <img id="imgOtherPointCard" src="/static/dsi/static/images//banner/pointcard_pic_USA.gif" style="max-width:70px; display:inline-block; margin-top:6px; margin-left:8px;" />
            <div id="msgOtherPointCard" style=" display:inline-block;"">
                <span class="vh_middle tx12" style=" display:inline-block; position:absolute; bottom:70px; left:110px;"">Redeem<BR>Nintendo DSi Points Card</span>
            </div>
        </a>
        </div>
            <div id="button_256x56" class="button_256x56" shpbtn>    
                   <a href="#?=2">
            <img id="imgOtherCreditCard" style=" display:inline-block; margin-top:15px; margin-left:8px;"" src="/static/dsi/static/images//banner/card_2.png" />
            <div id="msgOtherCreditCard" style=" display:inline-block;"">
                <span class="vh_middle tx12" style=" display:inline-block; position:absolute; bottom:13px; left:110px;"">Buy Nintendo DSi Points<BR>with a Credit Card</span>
                </div>
            </div>
        </a>

        <a href="/W_03.jsp">
        <div class="btn_base button_left" id="btn_BackInPoints" shpbtn style="margin-top:-30px;">
            <span class="btn_inner tx12 cWhite">Back</span>
        </div>
    </a>
    </div>
