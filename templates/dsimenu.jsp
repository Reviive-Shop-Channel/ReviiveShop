...
<title>Return to DSi Menu</title>
<script type="text/JavaScript">
<!--
...
<div class="preload" id="scene_contents"  style=" margin-top:215px; display:none;">
    ...
    <div style="display:block;">
        <div class="message tx16 cBlue" >
            ...
            <span style="color:grey; font-size:8px; position:absolute; top:80px; left:100px; ">(wii shop main pg)</span>
        </div>
...
<div class="preload" id="up_contents">
    <div>
        <div class="tx16 cTitle page_title">Return to DSi Menu</div>
