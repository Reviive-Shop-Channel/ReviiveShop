...
<!----- Scene Contents ----->
<div class="preload" id="scene_contents"  style=" margin-top:215px;">
    <!-- scene Main -->
    <div>
        <a href="/dsiware">
        <div class="btn_base button_256x56" id="btn_DSiWare" shpbtn>
            <span class="btn_inner"><img src='/static/dsi/static/images/logo_dsiware_USA_en.png'/></span>
        </div>
        </a>
        <a href="/dsipointspg1">
        <div class="btn_base button_128x40" id="btn_AddPoints" onmouseup="parent.points += 100; showCurrentBalance();">
